package com.aeye.aeaimb.common.core.util.agora.sample;

import com.aeye.aeaimb.common.core.util.agora.media.DynamicKey5;
...
public class Verifier5 {
    public static void main(String[] args) throws Exception {
        if (args.length < 5) {
            System.out.println("java cdss.agora.media.sample.Verifier5 appID appCertificate channelName uid channelKey");
            return;
        }
