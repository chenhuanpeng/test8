...
import com.aeye.aeaimb.common.core.jackson.CdssJavaTimeModule;
import com.aeye.aeaimb.common.log.config.CdssLogProperties;
import com.aeye.aeaimb.mkpb.entity.sys.SysLog;
import com.aeye.aeaimb.mkpb.feign.RemoteMkpbLogService;
...
public class MkpbSysLogListener implements InitializingBean {

	// new 一个 避免日志脱敏策略影响全局ObjectMapper
	private final static ObjectMapper objectMapper = new ObjectMapper();

	private final RemoteMkpbLogService remoteMkpbLogService;

	private final CdssLogProperties logProperties;

	@SneakyThrows
	@Async
	@Order
	@EventListener(MkpbSysLogEvent.class)
	public void saveSysLog(MkpbSysLogEvent event) {
		...
		remoteMkpbLogService.saveLog(sysLog, SecurityConstants.FROM_IN);
	}
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new CdssJavaTimeModule());
	}
