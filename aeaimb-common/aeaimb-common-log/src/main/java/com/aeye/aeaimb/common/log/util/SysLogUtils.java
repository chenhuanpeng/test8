...
package com.aeye.aeaimb.common.log.util;
...
import com.aeye.aeaimb.common.log.event.SysLogEventSource;
...
public class SysLogUtils {
	...
	public SysLogEventSource getSysLog() {
		...
		if (StringUtils.isBlank(sysLog.getServiceId())){
			sysLog.setServiceId(SpringUtil.getProperty("spring.application.name"));
		}

		// get 参数脱敏
		CdssLogProperties logProperties = SpringContextHolder.getBean(CdssLogProperties.class);
