...
package com.aeye.aeaimb.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public CdssUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof CdssUser) {
			return (CdssUser) principal;
		}
		return null;
	}
	 ...
	 * 获取用户
	 */
	public MkpbUser getMkpbUser() {
		Authentication authentication = getAuthentication();
		if (authentication == null) {
			return null;
		}
		Object principal = authentication.getPrincipal();
		if (principal instanceof MkpbUser) {
			return (MkpbUser) principal;
		}
		return null;
	}
