...
public class CdssResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public CdssBearerTokenExtractor cdssBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new CdssBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new CdssCustomOpaqueTokenIntrospector(authorizationService);
	}
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new CdssOAuthRequestInterceptor(tokenResolver);
	}
