 ...
 * @date 2021/12/21
 */
public interface MkpbUserDetailsService extends UserDetailsService, Ordered {
	...
	default UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new MkpbUser(user.getUserId(), user.getDeptId(), user.getUsername(),
	 ...
	 * @return
	 */
	default UserDetails loadUserByUser(MkpbUser pigUser) {
