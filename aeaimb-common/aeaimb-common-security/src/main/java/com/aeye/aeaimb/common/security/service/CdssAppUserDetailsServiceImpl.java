...
public class CdssAppUserDetailsServiceImpl implements CdssUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (CdssUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(CdssUser cdssUser) {
		return this.loadUserByUsername(cdssUser.getPhone());
	}
