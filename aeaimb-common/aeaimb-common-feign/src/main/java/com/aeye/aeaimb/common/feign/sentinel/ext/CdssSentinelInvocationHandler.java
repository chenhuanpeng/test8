...
import com.aeye.aeaimb.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class CdssSentinelInvocationHandler implements InvocationHandler {
	...
	CdssSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			CdssSentinelInvocationHandler other = (CdssSentinelInvocationHandler) obj;
