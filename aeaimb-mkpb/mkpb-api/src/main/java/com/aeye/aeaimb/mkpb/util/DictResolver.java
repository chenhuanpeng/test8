...
import com.aeye.aeaimb.mkpb.feign.RemoteMkpbDictService;
...
public class DictResolver {
	...
	public List<SysDictItem> getDictItemsByType(String type) {
		...
		RemoteMkpbDictService remoteDictService = SpringContextHolder.getBean(RemoteMkpbDictService.class);
