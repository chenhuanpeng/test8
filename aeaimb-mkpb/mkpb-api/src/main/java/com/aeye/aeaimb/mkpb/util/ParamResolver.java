package com.aeye.aeaimb.mkpb.util;
...
import com.aeye.aeaimb.mkpb.feign.RemoteMkpbParamService;
...
public class ParamResolver {
	...
	private <T> T checkAndGet(String key, Class<T> clazz, T... defaultVal) {
		...
		RemoteMkpbParamService remoteParamService = SpringContextHolder.getBean(RemoteMkpbParamService.class);
