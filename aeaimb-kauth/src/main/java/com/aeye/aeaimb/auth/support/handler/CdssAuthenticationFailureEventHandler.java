...
import com.aeye.aeaimb.common.log.util.LogTypeEnum;
 ...
 */
@Slf4j
public class CdssAuthenticationFailureEventHandler implements AuthenticationFailureHandler {
	...
	private void sendErrorResponse(HttpServletRequest request, HttpServletResponse response,
		...
		final R<Object> failed = R.failed(errorMessage);
		failed.setCode("424");
		this.errorHttpResponseConverter.write(failed, MediaType.APPLICATION_JSON, httpResponse);
	}
