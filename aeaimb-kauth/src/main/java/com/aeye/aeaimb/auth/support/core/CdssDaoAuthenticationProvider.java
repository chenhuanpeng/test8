 ...
 * @date 2022-06-04
 */
public class CdssDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public CdssDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		if (!optional.isPresent()) {
			throw new InternalAuthenticationServiceException("MkpbUserDetailsService error , not register");
		}
